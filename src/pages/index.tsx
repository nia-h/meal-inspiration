    ...
    <>
      ...
      <main className="text-sm  text-text_primary_400">
          ...
          <div className="general-container">
            <div className="nav-wrapper flex items-center justify-between">
              ...
              <button
                ...
                className="mobile-nav-toggle fixed right-4 top-8 cursor-pointer border-0 bg-transparent p-[0.5em] sm:hidden"
        ...
        <div className="body">
          ...
          <section className="cta relative isolate bg-bg_accent_400 py-20 text-center text-text_neutral_100 before:absolute before:inset-0 before:-z-10 before:bg-cta_image before:bg-cta_image_position before:bg-no-repeat before:opacity-10 before:content-['']">
        ...
        <footer className="text-text isolate bg-bg_neutral_900 py-12 text-text_accent_100">
          ...
          <div className="general-container">
            <div className="grid gap-12 after:col-start-1 after:col-end-[-1]  sm:grid-flow-col">
              <div className="order-last flex flex-col-reverse items-center gap-12 start:me-auto start:ms-auto sm:order-first sm:flex-col sm:items-start sm:justify-between">
                <Link href="/" className="">
                  <Image
                    className="h-auto max-w-16"
                    src={logo}
              ...
              <div className="order-first grid content-between start:me-auto start:ms-auto sm:order-last">
                <form action="" className="flex gap-2">
                  <input type="email" className="rounded-full px-3 py-4" />
                  <button className="btn-main btn shadow-none">Go</button>
                </form>
